...
public class ActiveRacesVehiclesActivity extends AppCompatActivity  {
    ...
    private ActiveRacesVehiclesAdapter mAdapter;
    private RecyclerView.LayoutManager mLayoutManager;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_active_races_vehicles);
        ...
        mAdapter = new ActiveRacesVehiclesAdapter(this, mRaceVehicleList);
        ...
        call.enqueue(new Callback<List<RaceVehicle>>() {
            ...
            public void onResponse(Call<List<RaceVehicle>> call, Response<List<RaceVehicle>> response) {
                ...
                if (!response.isSuccessful()) {
                    ...
                    Util.errorToast(ActiveRacesVehiclesActivity.this, response.message());
                }
                else {
